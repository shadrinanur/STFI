...
<footer class="relative  bg-gray-900 px-4 pt-20">
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-sky-500 bg-white p-2"><img class="h-full object-contain" src="../assets/logostfi.png" alt="" /></div>
  ...
  <p class="py-10 text-center text-gray-300">© 2023 STFI | All Rights Reserved</p>
</footer>
